...
class Buffer : public Noncopyable {
 public:
  ...
  void appendInt64(int64_t x) {
    int64_t be64 = SockUtil::hostToNetwork64(x);
  ...
  void appendInt32(int32_t x) {
    int32_t be32 = SockUtil::hostToNetwork32(x);
  ...
  int64_t peekInt64() const {
    ...
    return SockUtil::networkToHost64(be64);
  }
  ...
  int16_t peekInt16() const {
    ...
    return SockUtil::networkToHost16(be16);
  }
